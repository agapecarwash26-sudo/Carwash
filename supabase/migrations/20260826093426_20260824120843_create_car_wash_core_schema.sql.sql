...
-- Tenant data is intentionally not seeded here.
-- New installations create the first site from the Auth signup trigger.
-- Generic services/products are bootstrapped per site by the hardening migration.
