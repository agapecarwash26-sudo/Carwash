...
Deno.serve(async(req)=>{
 ...
 try{
  ...
  const tables=['offline_operations','audit_logs','loyalty_transactions','payments','order_items','orders','stock_movements','expenses','cash_movements','cash_registers','appointments','complaints','notifications','subscriptions','vehicles','customers','employees'];
