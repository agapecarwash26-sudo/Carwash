  ...
  try {
    ...
    for (const op of operations) {
      ...
      try {
        ...
        // Succès confirmé par Supabase : on supprime l'entrée locale.
        // Une opération synchronisée n'a plus aucune raison de rester dans
        // IndexedDB et ne doit donc jamais réapparaître comme opération en attente.
