...
export async function saveOrderServerId(localOrderId: string, serverOrderId: string) { return metaSet(`order_server_id:${localOrderId}`, serverOrderId); }
export async function getOrderServerId(localOrderId: string) { return metaGet<string>(`order_server_id:${localOrderId}`); }
export async function saveCustomerServerId(localCustomerId: string, serverCustomerId: string) { return metaSet(`customer_server_id:${localCustomerId}`, serverCustomerId); }
export async function getCustomerServerId(localCustomerId: string) { return metaGet<string>(`customer_server_id:${localCustomerId}`); }
