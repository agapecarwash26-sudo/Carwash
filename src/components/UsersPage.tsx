...
function NewUserModal({ onClose, onCreated }: { onClose: () => void; onCreated: () => void }) {
  ...
  async function submit(e: React.FormEvent) {
    ...
    try { const created=await createUser({ email, password, full_name: name, role, menu_keys: selectedMenus }); onCreated(); } catch (e) { setError(e instanceof Error ? e.message : 'Impossible de créer l\'utilisateur.'); } finally { setSaving(false); }
  }
